...
# Desafio02 - Adicionando Segurança em APIs na AWS com Amazon Cognito
...
- Protocol - REST -> Create new API -> API name [desafio02-aws] -> Endpoint Type - Regional -> Create API
...
- Domain name -> Domain prefix [bootcampaws] -> Save
...
- Auth URL [https://bootcampaws.auth.sa-east-1.amazoncognito.com/login]
...
#### Referências
Implementação foi baseada na aula do Desafio 
Adicionando Segurança em APIs na AWS com Amazon Cognito
